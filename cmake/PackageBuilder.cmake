...
function(_package_check_initialized)
  ...
  if(NOT package_initialized)
    message(
      FATAL_ERROR
        "package_create() must be called before all other PackageBuilder functions."
    )
  endif()
endfunction()
...
function(package_create)
  ...
  # If the project uses cmake-conan make sure Conan has been invoked to avoid an
  # error Conan is invoke on the first call to "find_package()" This line only
  # exists to prevent it from complaining about projects that don't consume
  # packages
...
function(package_install)
  ...
  if(targets)
    # Create an export package of the targets Use GNUInstallDirs and COMPONENTS
    # See "Deep CMake for Library Authors"
  ...
  get_property(public_header_paths GLOBAL
               PROPERTY ${PROJECT_NAME}_PUBLIC_HEADER_PATHS)
